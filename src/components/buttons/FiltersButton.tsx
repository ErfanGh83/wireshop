...
const FiltersButton = ({ setFiltersModuleOpen, filtersModuleIsOpen }: Props) => {
    ...
    return (
        <button
            onClick={handleClick}
            className='size-fit p-1 flex items-center justify-center gap-1 rounded-md border-[1px] border-black text-sm sm:text-xl cursor-pointer hover:text-blue-400 text-black bg-white transition-colors'
        >
