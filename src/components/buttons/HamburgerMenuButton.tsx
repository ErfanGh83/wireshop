...
const HamburgerMenuButton = ({ hamMenuIsOpen, setHamMenuIsOpen }: Props) => {
    ...
    return (
        <motion.button
            className={`size-8 xl:size-10 flex flex-col items-center justify-center space-y-1.5 bg-transparent hover:cursor-pointer focus:outline-none relative z-40 hover:bg-blue-100 dark:hover:bg-slate-700 transition-colors 
