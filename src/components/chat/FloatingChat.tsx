        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="fixed bottom-0 right-0 left-0 top-0 bg-black/50 dark:bg-black/80 z-15"
            ...
            <motion.div
              ...
              className="fixed bottom-24 right-6 w-80 md:w-120 max-w-full h-120 bg-white dark:bg-slate-700 text-black dark:text-gray-100 rounded-2xl shadow-2xl z-17 flex flex-col overflow-hidden"
            >
