...
const SubHeaderItemsContainer = () => {
    ...
    return (
        <div className="flex w-screen sm:w-fit h-20 sm:h-12 flex-row items-center justify-around sm:justify-center sm:gap-4 sm:p-2 bg-white rounded-bl-full shadow-md">
