...
const SubHeader = () => {
    return (
        <div
            className='hidden w-screen h-16 xl:h-12 sm:flex flex-row-reverse items-center justify-between px-2 border-b-2 bg-white dark:bg-slate-800 border-gray-100 dark:border-gray-700'
        >
