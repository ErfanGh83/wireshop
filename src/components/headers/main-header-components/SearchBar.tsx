...
const SearchBar = () => {
    ...
    return (
        ...
        >
            ...
            <button className="size-full flex items-center justify-center text-blue-400 cursor-pointer hover:bg-blue-500 hover:text-white dark:hover:text-purple-200 transition-colors">
                <BiSearch size={24} />
            </button>
        </div>
    )
