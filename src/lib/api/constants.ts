...
export const ERROR_MESSAGES = {
  admin: {
    0: "پاسخی از سمت سرور دریافت نشد. بعدا دوباره تلاش کنید",
  ...
  check_out: {
    ...
    400: "مقدار نا معتبر یا موجودی نا کافی.",
    401: "دوباره وارد شوید.",
    404: "کاربر یا آدرسی یافت نشد",
    409: "برخی از محصولات انتخابی قیمت ندارند. با پشتیبانی تماس بگیرید",
    500: "خطایی درون سرور رخ داد",
  },
  comment: {
    0: "پاسخی از سمت سرور دریافت نشد. بعدا دوباره تلاش کنید",
  ...
  support: {
    ...
    403: "لطفا با دسترسی پشتیبان وارد شوید.",
    500: "خطایی از سمت سرور رخ داد.",
  },
};
