...
export const API_ENDPOINTS = {
  ...
  LOGIN: "/api/auth/signup/complete", //method: POST, request body: phone number + password, 200: Login successful (gives a JWT token), 401: Invalid password, 404: User not found.
  LOGOUT: "/api/auth/signup/complete", //method: POST, 200: Logged out successfully.
